...
--modified
component unsigned_signed_extend_8to16 is
...
signal id_indir_reg_a : std_logic_vector(7 downto 0);
signal id_read_a_resolved : std_logic_vector(7 downto 0);
...
begin
   ...
   pc_next_inst_mux : mux_2to1_8b
    ...
    unsign_sign_extend : unsigned_signed_extend_8to16 
    ...
    port map ( reset           => reset, 
               ...
               register_a_indir => id_indir_reg_a);
               
    mux_resolve_reg_a:
        with c_id_indir_read_a select id_read_a_resolved <= id_indir_reg_a when '1',
                                                            id_inst(23 downto 16) when others;                  
