...
constant OP_LOW     : std_logic_vector(7 downto 0) := X"0f";
...
------------------ don't need -----------------
--	LW 	  R1 R2 imm	    don't need
--	SW	  R1 R2 imm	    don't need
-------------------------------------------------
...
begin
    ...
    control_bus_new(2) <= '1' when (opcode = OP_LOA or
                                    opcode = OP_LOW) else '0';
